...
<div class="wrapper">
    ...
    <ul class="main-menu__list text-center">
        <a href="<?php echo base_url('user/login'); ?>" class="btn btn-warning btn-sm wow rotateInDownRight" data-wow-duration="2s" style="margin:10px;">LOGIN</a>
        <a href="<?php echo base_url('user/register'); ?>" class="btn btn-warning btn-lg wow rotateInDownLeft" data-wow-duration="2s">REGISTER NEW ACCOUNT</a>
    </ul>
</div>
